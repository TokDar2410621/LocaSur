...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      {children}
      <DialogPrimitive.Close className="absolute right-3 top-3 sm:right-4 sm:top-4 rounded-full w-8 h-8 flex items-center justify-center bg-muted/50 opacity-70 ring-offset-background transition-all hover:opacity-100 hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none touch-target">
        <X className="h-4 w-4" />
